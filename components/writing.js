...
export default function Writing() {
  ...
  return <div className="flex flex-col justify-center mx-auto mb-20 px-5 text-grey-dark">
    <SectionHeader title="Writing" description="Sharing with other designers, educators and product builders."></SectionHeader>
